...
The average difference between our a-estimate and pseudo-a statistic was `r mean(all_sims$differenceA)`, with a $t_{(4940181)}$=`r ttest_a$statistic`, *p*<0.05. The average difference between our b-estimate and pseudo-b statistic was `r mean(all_sims$differenceB)`, with a $t_{(4940181)}$=`r ttest_b$statistic`, *p*=0.18. 
