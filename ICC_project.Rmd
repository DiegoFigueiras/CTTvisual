...
hist(sim6means$colMeans.sim6.)
              ...
              y <- runif(1000,0,1)
                  z <- runif(1000,0,1)
                  normal <- ifelse(y<.2, 0,1)
                
                  dist_ma <- "norm"
                 
                  #x <- runif(ma,0,1)
                  #pos.skew <-(5-(4*(x^(1/3))))  #positive skewed 1-5
                  #ppu.male.a <- data.frame(ratings = pos.skew, gender = "male", dept = "A")
                  #dist_ma <- "pos"
                 
                  #x <- runif(ma,0,1)
                  #neg.skew<-((4*(x^(1/3)))+1)  #negative skewed 1-5
                  #ppu.male.a <- data.frame(ratings = neg.skew, gender = "male", dept = "A")
                  #dist_ma <- "neg"
