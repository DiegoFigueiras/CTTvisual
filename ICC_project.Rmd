...
coeficients<-read.csv("coefficients.csv")%>%select(-X)
coef_old<-read.csv("coefficients_old.csv")
coef_old<-coef_old%>%filter(simulation=="Simulation 2")%>%select(-X)
coeficients<-rbind(coeficients, coef_old)
