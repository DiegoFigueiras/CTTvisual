...
```{r example, include=TRUE, fig.cap="Item characteristic curves reflecting predominant visual differences in difficulty and discrimination.", echo=FALSE, warning=FALSE, message=FALSE, out.width = "100%", out.height="80%"}
...
@lord1980applications described a function that approximates the relationship between the IRT *a*-parameter and the CTT discrimination index of an item-test biserial correlation:
