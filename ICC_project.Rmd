...
We simulated data using @han2007wingen3 software. Our sample was 10,000 observations, with a mean of 0 and a standard deviation of 1. The number of items were 50, with response categories of either correct or incorrect (1 and 0).
...
pseudob<-abs(qnorm(mean(data$V50)))
...
pseudoa<-ahat(.552939712)
c <- 0

eq <- function(x){c + ((1-c)*(1/(1+2.71828^(-1.7*(pseudoa*(x-pseudob))))))}

p1<-plot(mod, which.items=c(50), main="Item Characteristic Curves")+latticeExtra::layer(panel.curve(eq, col="red"))

pseudob<-abs(qnorm(mean(data$V47)))
ahat<-function(x){
  r<-(((2.71828)^x)-(1/(2.71828)^x))/(2.71828-(2.71828)^x)
...
pseudoa<-ahat(.173791903)
eq <- function(x){c + ((1-c)*(1/(1+2.71828^(-1.7*(pseudoa*(x-pseudob))))))}

p2<-plot(mod, which.items=c(47), main="Item Characteristic Curves")+latticeExtra::layer(panel.curve(eq, col="red"))
pseudob<-abs(qnorm(mean(data$V21)))
ahat<-function(x){
  r<-(((2.71828)^x)-(1/(2.71828)^x))/(2.71828-(2.71828)^x)
...
pseudoa<-ahat(.143276546)
eq <- function(x){c + ((1-c)*(1/(1+2.71828^(-1.7*(pseudoa*(x-pseudob))))))}

p3<-plot(mod, which.items=c(21), main="Item Characteristic Curves")+latticeExtra::layer(panel.curve(eq, col="red"))

pseudob<-abs(qnorm(mean(data$V7)))
ahat<-function(x){
  r<-(((2.71828)^x)-(1/(2.71828)^x))/(2.71828-(2.71828)^x)
...
pseudoa<-ahat(.343460055)
eq <- function(x){c + ((1-c)*(1/(1+2.71828^(-1.7*(pseudoa*(x-pseudob))))))}

p4<-plot(mod, which.items=c(7), main="Item Characteristic Curves")+latticeExtra::layer(panel.curve(eq, col="red"))

require(gridExtra)
grid.arrange(p1,p2, p3,p4, ncol=2, nrow=2)
curve(eq, col="red", from=-100, to=100)
...
p1<-plot(mod, which.items=c(50), main="Item Characteristic Curves")+latticeExtra::layer(panel.curve(eq1, col="red"))
p1
pseudob<-.2
pseudoa<-.9

eq2 <- function(x){c + ((1-c)*(1/(1+2.71828^(-1.7*(pseudoa*(x-pseudob))))))}
p2<-plot(mod, which.items=c(47), main="Item Characteristic Curves")+latticeExtra::layer(panel.curve(eq2, col="red"))
p2
pseudob<-.6
pseudoa<-.3
eq3 <- function(x){c + ((1-c)*(1/(1+2.71828^(-1.7*(pseudoa*(x-pseudob))))))}

p3<-plot(mod, which.items=c(21), main="Item Characteristic Curves")+latticeExtra::layer(panel.curve(eq3, col="red"))
p3

pseudob<-.1

pseudoa<-.4
eq4 <- function(x){c + ((1-c)*(1/(1+2.71828^(-1.7*(pseudoa*(x-pseudob))))))}

p4<-plot(mod, which.items=c(7), main="Item Characteristic Curves")+latticeExtra::layer(panel.curve(eq4, col="red"))
p4

require(gridExtra)
grid.arrange(p1,p2, p3,p4, ncol=2, nrow=2)

curve(eq3, col="red", from=-100, to=100)
plot(mod, which.items=c(47))
...
p1<-plot(mod, which.items=c(47), main="Item Characteristic Curves")+latticeExtra::layer(panel.curve(eq, col="red"))
p1
################################################################
...
p2<-plot(mod, which.items=c(1), main="Item Characteristic Curves")+latticeExtra::layer(panel.curve(eq2, col="red"))
p2
...
p3<-plot(mod, which.items=c(54), main="Item Characteristic Curves")+latticeExtra::layer(panel.curve(eq3, col="red"))
p3
###############################################################################
pseudob4<- dat$b[25]
ahat<-function(x){
...
p4<-plot(mod, which.items=c(25), main="Item Characteristic Curves")+latticeExtra::layer(panel.curve(eq4, col="red"))
p4
###############################################################################
require(gridExtra)
