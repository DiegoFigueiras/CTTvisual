---
title             : "Item Characteristic Curve specification via Classical Test Theory"
shorttitle        : "CTT ICCs"
author: 
...
```{r diff, message=FALSE, warning=FALSE, paged.print=FALSE, cache=TRUE}
