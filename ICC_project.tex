...
We used R (Version 4.1.1; R Core Team, 2021) and the R-packages \emph{papaja} (Version 0.1.0.9999; Aust \& Barth, 2022), \emph{psych} (Version 2.1.9; Revelle, 2021), \emph{reticulate} (Version 1.22; Ushey et al., 2021), and \emph{tinylabels} (Version 0.2.3; Barth, 2022) for all our analyses.
