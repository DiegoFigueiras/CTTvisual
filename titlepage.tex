...
\urlstyle{same}
\hypersetup{
  pdftitle={Item Characteristic Curve estimation via Classical Test Theory specification},
...
\title{Item Characteristic Curve estimation via Classical Test Theory specification}
